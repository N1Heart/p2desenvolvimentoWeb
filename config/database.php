...
class Database
{
    // 1. AQUI: Declaramos as propriedades, mas sem valor.
    private $host;
    private $db_name;
    private $username;
    private $password;
    ...
    {
        // 2. AQUI: Atribuímos os valores do Docker DENTRO do construtor
        ...
        try {
            ...
            echo "Erro de conexão: " . $e->getMessage() . 
                 "<br><br><strong>Dica:</strong> Verifique se o container 'mysql' está rodando e se as variáveis de ambiente (DB_HOST, DB_NAME, etc.) estão corretas em 'docker-compose.yml' e 'config/database.php'.";
            exit; // Para a execução se não conectar
        }
    }
